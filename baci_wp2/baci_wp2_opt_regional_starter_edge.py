...
# tile = 'h17v03''h19v12', 'h20v11', 'h20v12'
# tile = 'h17v04'
# tile = 'h17v05'
# tile = 'h18v03'
# tile = 'h18v04'
        ...
        for ulx in xrange(ul_px, ul_px + N, cols):
            for uly in xrange(ul_py, ul_py + M, rows):
                ...
                # !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
                    ...
                    com_str =\
                    'python kernel_opt_regional_edge.py --ncd_out %s --root %s --pattern %s --year %d --tile %s --ulx %d --uly %d --cols %d --rows %d --step %d' % \
